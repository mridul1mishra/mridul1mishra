...
namespace AD.Alipay
{
    public partial class AlipayNotify3 : System.Web.UI.Page
    {
            ...
            if (sArray.Count != 0)
            {
                ...
                if (flag)
                {
                    ...
                    try
                    {
                        ...
                        message.Body = string.Format("<table><tbody><tr><td>商户订单号</td><td>{0}</td></tr><tr><td>支付日期</td><td>{1}</td></tr><tr><td>付款总金额</td><td>{2}</td></tr><tr><td>收款公司</td><td>{3}</td></tr><tr><td>支付方式</td><td>支付宝</td></tr></tbody></table>", out_trade_no, trade_time, total_fee, "富士施乐租赁（中国）有限公司");
