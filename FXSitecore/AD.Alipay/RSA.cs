...
namespace AD.Alipay
{
    public sealed class RSAFromPkcs8
    {
        ...
        /// sign
        /// </summary>
        /// <param name="content">pre-sign</param>
        /// <param name="privateKey">private key</param>
        /// <param name="input_charset">charset</param>
        /// <returns></returns>
        ...
        {
            Sitecore.Diagnostics.Log.Error("FileName:" + filename, "loadCert");
        ...
        /// <param name="signedString">verify result</param>
        ...
        public static bool verify(string content, string signedString, string publicKey, string input_charset)
        {
            ...
            Sitecore.Diagnostics.Log.Error("sign " + result.ToString(), "");
            return result;
        }
        ...
        /// Decrypt with RSA
        /// </summary>
        /// <param name="resData">cryptograph</param>
        /// <param name="privateKey">private key</param>
        /// <param name="input_charset">charset</param>
        ...
        /// <summary>
		/// Parse the private key of the pem file generated
        /// </summary>
        ...
        private static RSACryptoServiceProvider DecodeRSAPrivateKey(byte[] privkey)
        {
            ...
            {
                Sitecore.Diagnostics.Log.Error("RSA Decode: " + ex.Message, ex);
                return null;
            }
            finally { binr.Close(); }
        }
