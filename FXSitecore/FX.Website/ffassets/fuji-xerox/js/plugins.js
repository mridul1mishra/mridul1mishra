...
(function(){
	...
	D.ready(function() {
		...
		$("<style type='text/css'>.fancybox-margin{margin-right:" + (w2 - w1) + "px;} .quick-links.sticky.fancybox-margin{padding-right:" + (w2 - w1) + "px;}</style>").appendTo("head");
	});
...
}(jQuery));;;(function (name, context, factory) {
