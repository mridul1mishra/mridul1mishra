(function ($scw, scBeacon) {
    ...
    $scw.widget("wffm.wffmForm", {
        ...
        formSubmitSuccess: function (form, res) {
            ...
            if ($scw(form).find(".g-recaptcha-response").length > 0 && $scw(form).find(".g-recaptcha-response").val() == '') {
                jQuery('<span class="field-validation-error help-block" data-valmsg-replace="true">The field Captcha is invalid.</span>').insertAfter(".sitecore-form form");
                return false;
            }
